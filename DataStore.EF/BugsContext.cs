...
namespace DataStore.EF
{
    public class BugsContext : DbContext
    {
        ...
        protected override OnModelCreating (ModelBuilder modelBuilder){
            modelBuilder.Entity<Project>().HasMany(p => p.tickets).WithOne(t => t.projects)
            ...
            modelBuilder.Entity<Ticket>().HasData(
                ...
                new Ticket { TicketId=3 , Title="Bug #3", ProjectId=3},
                new Ticket { TicketId=4 , Title="Bug #4", ProjectId=4}
